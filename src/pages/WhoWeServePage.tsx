...
const WhoWeServePage = () => (
  <div className="min-h-screen">
    ...
    <PageHero
      ...
      title={<>Built for Those Who Take{" "}<span className="text-gold italic">Capital Seriously</span></>}
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-20">
        <div className="grid md:grid-cols-2 gap-16 items-start">
          <ScrollReveal direction="left">
            <div>
              <span className="text-gold text-xs font-semibold uppercase tracking-[0.2em]">For Investors</span>
              <h2 className="font-serif text-3xl md:text-4xl font-bold text-foreground mt-4">Deploy Capital With Certainty</h2>
              ...
              <Link to="/engage" className="inline-flex items-center gap-2 bg-gold text-foreground font-semibold px-6 py-3 rounded-md mt-8 hover:brightness-110 transition-all">
          ...
          <ScrollReveal direction="right">
            <div>
              <span className="text-gold text-xs font-semibold uppercase tracking-[0.2em]">For Asset Owners</span>
              <h2 className="font-serif text-3xl md:text-4xl font-bold text-foreground mt-4">Become Bankable</h2>
              <p className="text-muted-foreground mt-4 leading-relaxed">
              ...
              <Link to="/engage" className="inline-flex items-center gap-2 border-2 border-gold text-gold font-semibold px-6 py-3 rounded-md mt-8 hover:bg-gold hover:text-foreground transition-all">
