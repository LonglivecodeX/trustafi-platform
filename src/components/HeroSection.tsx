...
const HeroSection = () => {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-center gradient-hero overflow-hidden pt-20 pb-24"
    >
      {/* Background pattern */}
      <div
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-6 md:px-20 w-full pb-16">
        <div className="grid md:grid-cols-2 gap-12 md:gap-8 items-center min-h-[80vh]">
          ...
          <div className="space-y-6 animate-fade-up">
            ...
            <p className="text-primary-foreground/60 text-lg md:text-xl max-w-md leading-relaxed">
